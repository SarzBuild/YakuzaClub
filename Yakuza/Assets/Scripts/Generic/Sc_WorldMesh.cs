...
namespace Fork
{
    public class Sc_WorldMesh : MonoBehaviour
    {
        public class World_Mesh
        {
            ...
            public World_Mesh(Transform parent, Vector3 localPosition, Vector3 localScale, float eulerZ,
                float meshWidth, float meshHeight, Material material, UVCoords uvCoords, int sortingOrderOffset)
            {
